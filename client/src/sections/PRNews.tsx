  ...
  const newsItems = [
    {
      ...
      link: "https://www.kdpress.co.kr/news/articleView.html?idxno=204229",
      external: true,
    },
    {
      id: "franchise",
